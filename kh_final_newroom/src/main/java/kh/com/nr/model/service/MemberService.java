...
//	public Paging searchName(int pageNumber, int pageListLimit, String username); // 회원정보 이름 조회
	...
	public Paging getPage(int pageNumber, int pageListLimit, String name);
}
